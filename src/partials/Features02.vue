<template>
  <section class="relative border-t border-slate-800">
    ...
    <!-- Bg gradient: top -->
    <div class="absolute top-0 left-0 right-0 bg-linear-to-b from-slate-800 to-transparent opacity-25 h-[25rem] pointer-events-none -z-10" aria-hidden="true"></div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <!-- Box -->
        <div class="bg-slate-800/60 rounded-sm overflow-hidden">
            ...
            <div class="md:min-w-[28rem] p-6 lg:p-10">
              ...
              <div class="mb-6 lg:mb-8">
                <div class="flex flex-wrap -m-1.5">
                  <button class="btn-sm px-3 py-1 shadow-xs rounded-full m-1.5" :class="category === '1' ? 'text-white bg-indigo-500' : 'text-slate-300 bg-slate-700 hover:bg-slate-600 border-slate-600'" @click="category = '1'">Everyone</button>
                  <button class="btn-sm px-3 py-1 shadow-xs rounded-full m-1.5" :class="category === '2' ? 'text-white bg-indigo-500' : 'text-slate-300 bg-slate-700 hover:bg-slate-600 border-slate-600'" @click="category = '2'">Freelancers</button>
                  <button class="btn-sm px-3 py-1 shadow-xs rounded-full m-1.5" :class="category === '3' ? 'text-white bg-indigo-500' : 'text-slate-300 bg-slate-700 hover:bg-slate-600 border-slate-600'" @click="category = '3'">Organizations</button>
                </div>
              </div>
