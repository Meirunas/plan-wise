<template>
  <section class="relative">
    ...
    <div
      class="hidden md:block absolute w-0.5 h-8 bottom-0 bg-slate-800 left-1/2 -translate-x-1/2"
      aria-hidden="true"
    ></div>
      ...
      <div class="py-12 md:py-20 border-t border-slate-800">
        ...
        >
          ...
          <div
            ...
            :key="index"
            class="relative flex justify-center items-center bg-slate-800 aspect-square p-2"
            data-aos="fade-up"
          ...
          >
            ...
            >
              ...
              <div
                :class="{
                  'absolute w-1/2 h-0.5 bg-slate-800 right-0': index === 0,
                  'absolute w-1/2 h-0.5 bg-slate-800 left-0': index === 5,
                  'absolute w-full h-0.5 bg-slate-800': index > 0 && index < 5,
                }"
              ></div>
            </div>
            ...
            <!-- Circle -->
            <div
              class="bg-linear-to-t from-slate-800 to-slate-900 w-20 h-20 rounded-full flex justify-center items-center"
            >
              <img
                :src="icon.src"
                :alt="icon.alt"
...
export default {
  ...
  data() {
    return {
      integrationIcons: [
        {
          src: "src/images/integration-icon-01.svg",
          alt: "Icon 01",
          width: 36,
          height: 46,
          delay: 0,
        ...
        {
          src: "src/images/integration-icon-02.svg",
          alt: "Icon 02",
          width: 46,
          height: 46,
          delay: 100,
        ...
        {
          src: "src/images/integration-icon-03.svg",
          alt: "Icon 03",
          width: 53,
          height: 45,
          delay: 200,
        ...
        {
          src: "src/images/integration-icon-04.svg",
          alt: "Icon 04",
          width: 48,
          height: 46,
          delay: 300,
        ...
        {
          src: "src/images/integration-icon-05.svg",
          alt: "Icon 05",
          width: 49,
          height: 48,
          delay: 400,
        ...
        {
          src: "src/images/integration-icon-06.svg",
          alt: "Icon 06",
          width: 48,
          height: 44,
          delay: 500,
